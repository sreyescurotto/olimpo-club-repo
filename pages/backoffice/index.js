...
export default function Backoffice () {
  return (
    <>
      <BackofficeLayout>
        <div>
          <p className='font-mono font-bold text-3xl'>Bienvenido</p>
          <p className='font-mono font-bold text-3xl'>Sergio Reyes</p>
          <div className='flex flex-col gap-6 my-6'>
            <div className='bg-transparent hover:bg-gray-100 text-white-700 font-semibold hover:text-gray-800 py-2 px-4 border border-gray-300 hover:border-gray-400 rounded shadow w-full text-center'>
